...
let LoginComponent = class LoginComponent {
    constructor(authService, store, dialog) {
...
let SignupComponent = class SignupComponent {
    ...
    ngOnInit() {
        ...
        this.authForm.controls.email.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["distinctUntilChanged"])()).subscribe((value) => {
